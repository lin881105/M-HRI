...
class Goal_8(Goal):
    def __init__(self):
        ...
        goal_pose_1.r = gymapi.Quat.from_euler_zyx(-np.pi/2, 0, 0)

        goal_pose_2 = gymapi.Transform()
        goal_pose_2.p = gymapi.Vec3(0, 0, 0.0435)
        goal_pose_2.r = gymapi.Quat.from_euler_zyx(0, 0, -np.pi/2)

        goal_pose_3 = gymapi.Transform()
        goal_pose_3.p = gymapi.Vec3(0, 0, 0.0625)

        goal_pose_3.r = gymapi.Quat.from_euler_zyx(-np.pi, 0, np.pi)


        self.block_height = [0.0145,0.0145,0.0045]
