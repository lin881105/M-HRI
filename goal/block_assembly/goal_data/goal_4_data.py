...
class Goal_4():
    def __init__(self):
        ...
        goal_pos_1 = torch.Tensor((0, 0, 0.0145)).to(device=self.device)
        ...
        goal_pos_2 = torch.Tensor((0.014, 0.001, 0.052)).to(device=self.device)

        goal_rot_2 = torch.Tensor((0.5*np.pi,np.pi,  0)).to(device=self.device)
        ...
        goal_pos_3 = torch.Tensor((-0.014,-0.001,  0.052)).to(device=self.device)
        ...
        self.block_height = [0.0145,0.023,0.023]
