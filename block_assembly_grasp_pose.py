...
for i in range(num_envs):
    ...
    region_handle = gym.create_actor(env, region_asset, region_pose, "target_reginon", i,1)
    ...
    i = 0
    for idx in goal_A:
        box_pose = utils.multiply_gymapi_transform(region_pose,utils.mat2gymapi_transform(goal_A_pose[i]))
        block_handle = gym.create_actor(env, block_asset_list[idx], box_pose, 'block_' + block_type[idx])
